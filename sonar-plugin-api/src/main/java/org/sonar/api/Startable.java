...
/**
 * An interface which is implemented by classes annotated with {@link org.sonar.api.batch.BatchSide},
 * {@link org.sonar.api.server.ServerSide} and/or {@link org.sonar.api.ce.ComputeEngineSide} (referred to below as
 ...
 * </p>
 * <p>
 * In the WebServer, a component is started once: either right when the WebServer is started if there is no migration, otherwise
 * only Database has been successfully migrated. And it is stopped once when the WebServer/ComputeEngine is shutdown.
 * </p>
 * <p>
 * In the Compute Engine, a component is started once when the Compute Engine is started and stopped once when the
 * ComputeEngine is shut down.
 * </p>
 * <p>
 * On Batch side, the lifecycle of a component depends on the value of the {@link org.sonar.api.batch.InstantiationStrategy}
 * annotation.
 * </p>
 */
